...
public:
	...
	FEditorDialogCreatorCommands()
		: TCommands<FEditorDialogCreatorCommands>(TEXT("DialogSystem"), NSLOCTEXT("Contexts", "DialogSystem", "DialogSystem Plugin"), NAME_None, FEditorDialogCreatorStyle::GetStyleSetName())
